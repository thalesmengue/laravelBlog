            ...
            <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                <div class="space-y-6 sm:space-y-5">
                    <div>
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">edit your post</p>
                    </div>
                        ...
                        <div
                            ...
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <textarea name="description" id="description" autocomplete="family-name"
                                          class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm
                                       focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs sm:text-sm">{{$post->description}}</textarea>
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="image"
                                                ...
                                                <input id="image" name="image" type="file" class="sr-only" value="{{ $post->image }}">
                                            </label>
