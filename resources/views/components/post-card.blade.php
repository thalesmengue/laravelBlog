<div class="relative bg-gray-50 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
    <div class="absolute inset-0">
        <div class="h-1/3 sm:h-2/3 flex float-right mr-12">
            @auth
                <div>
                    <button onclick="window.location='{{ route("posts.create") }}'" type="button" class="rounded-md border border-transparent
                bg-indigo-600 px-4 py-2 text-sm mt-4 font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none
                focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add Post
                    </button>
                </div>
            @endauth
        </div>
    ...
    <div class="relative mx-auto max-w-7xl">
        <div class="text-center">
            ...
            <p class="mx-auto mt-3 max-w-2xl text-xl text-gray-500 sm:mt-4">here you can find some laravel articles or
                tips</p>
        </div>
